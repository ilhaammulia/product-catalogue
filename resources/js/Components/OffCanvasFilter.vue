<template>
  ...
  <div id="offcanvas-filter" ref="canvas"
    ...
    <button type="button" @click="toggleCanvas" aria-controls="offcanvas-filter"
...
export default {
  ...
  mounted() {
    this.canvas = new Drawer(this.$refs.canvas, { bodyScrolling: true });
  },
  methods: {
    toggleCanvas() {
      this.canvas.toggle();
